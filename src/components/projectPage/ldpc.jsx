...
const TakeawaysUnorderedList = () => {
    return (
        <ul style={{ paddingLeft: "15px", color: "#555555" }}>
            <li>
                Browse departments, sub departments and aisles were popular ways
                to filter and recreate the physical shopping experience
            </li>
            {/*<li>Attaching key metrics into hypothesis that are comparative, ratio and behavior changing.</li>*/}
            <li>
                Allowing users to create a shopping list and searching multiple
                items on the list at a time
            </li>
...
const NextStepUnorderedList = () => {
    return (
        <ul style={{ paddingLeft: "15px", color: "#555555" }}>
            <li>
                Incorporating the feedback from the judging panel into our case
            </li>
            <li>Conduct usability testing on our prototype</li>
            <li>
                Gathering more insights about our users to validate the solution
            </li>
            <li>
                Explore other solutions and problems within this product area;
                there's always more problems to be fixed{" "}
            </li>
        </ul>
    );
};
const AssumpUnorderedList = () => {
    return (
        <ul style={{ paddingLeft: "15px", color: "#555555" }}>
            <li>
                It is hard for users to visualize the product size, colour, and
                quality
            </li>
            <li>
                Users cannot attest to the freshness of the product through
                online shopping which makes them less confident in their
                purchase
            </li>
            <li>The search process is confusing for prospective customers</li>
        </ul>
    ...
    render() {
        return (
            <div>
                ...
                <Container>
                    <Row>
                        <Col sm={12}>{/* <Text Titlee="The problem"/> */}</Col>
                        <Col sm={12}>
                        ...
                        <Col sm={12}>
                            <Text
                                statement={true}
                                contentt="For first time PC Express users, how might we support our users in the search process to give them confidence to purchase and decrease the number of incomplete orders."
                            />
                        </Col>
                        <Col sm={12}>
                    ...
                    <Row>
                        ...
                        <Col sm={12}>
                            ...
                            >
                                <li>
                                    It is hard for users to visualize the
                                    product size, colour, and quality
                                </li>
                                <li>
                                    Users cannot attest to the freshness of the
                                    product through online shopping which makes
                                    them less confident in their purchase
                                </li>
                                <li>
                                    The search process is confusing for
                    ...
                    <Row>
                        ...
                        <Col sm={8}>
                            ...
                            <a
                                ...
                                href="#lddesignprocess"
                            >
                                Show me the design process 👇🏻
                            </a>
                    ...
                    <Row>
                        ...
                        <Col sm={12}>
                            <Text
                                statement={true}
                                contentt="How do our first-time users discover products once they sign up?"
                            />
                        </Col>
                        <Col sm={12}>
                            <ul
                        ...
                        <Col sm={12}>
                            ...
                            >
                                <li>
                                    ...
                                    <b>expiry dates</b> for items
                                </li>
                                <li>
                                    When it comes to fruit and produce, users
                                    are worried about the{" "}
                                    <b>quality of their products</b> when
                                    shopping online
                                </li>
                                <li>
                                    Needs more <b>refinement in search</b>{" "}
                                    parameters
                                </li>
                            </ul>
                        </Col>
                ...
                <Container>
                    <Row>
                        ...
                        <Col sm={12}>
                            ...
                            >
                                <li>
                                    Browse departments, sub departments and
                                    aisles were popular ways to filter and
                                    recreate the physical shopping experience
                                </li>
                                <li>
                                    Allowing users to create a shopping list and
                                    searching multiple items on the list at a
                                    time
                                </li>
                                <li>Re-order items from previous purchases</li>
                            </ul>
                ...
                <Container>
                    ...
                    <Row>
                        ...
                        <Col sm={12}>
                            ...
                            >
                                <li>
                                    Decreased time in full funnel conversion
                                    (e.g Entering the platform and purchasing at
                                    least 1 item [cohort X])
                                </li>
                                <li>
                                    Number of individuals from [cohort X] that
                                    make a return purchase within 3 weeks
                                </li>
                                <li>
                                    Decreased duration spent on platform within
                                    search functionality
                                </li>
                                <li>
                                    Decreased number of search terms within a
                                    session
                                </li>
                            </ol>
                        </Col>
                ...
                <Container>
                    <Row>
                        <Col sm={12} id="lddesignprocess"></Col>
                        <Col sm={12}>
                            {/* <Text Titlee="Design Explorations"/> */}
                        </Col>
                        <Col sm={12}>
                            <Text title="03. Design Flow — the search cases" />
                        </Col>
                ...
                <Container>
                    <Row>
                        ...
                        <Col sm={12}>
                            ...
                            >
                                <li>
                                    A crucial factor to consider when
                                    implementing solutions was technical
                                    feasibility. While AI chatbots and AR
                                    grocery shopping sounds great to have, there
                                    is a level of complexity.
                                </li>
                                <li>
                                    Consistency in the assets and images for
                                    grocery shopping is an important part of the
                                    process. It was difficult to maintain the
                                    consistency when handling masses of products
                                    since some will have multiple images while
                        ...
                        <Col sm={12}>
                            ...
                            >
                                <li>
                                    Test and validate the remaining KPIs
                                    associated with our hypothesis
                                </li>
                                {/*<li>Would love to dive into the problem in-depth by considering the other ideas we explored</li>*/}
                                <li>
                                    Explore other solutions and problems within
                                    this product area; there's always more
                ...
                <Container className="bottom-breadcrumbs">
                    <nav style={{ fontFamily: "Karla" }}>
                        <ul className="breadcrumb justify-content-center">
                            ...
                            <li>
                                <a href="project_one#">SEARCH AND GATHER</a>
                            </li>
                            <li>
