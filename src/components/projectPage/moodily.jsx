    ...
    render() {
        return(
            <div>
                ...
                <Container>
                    <Row>
                        <Col sm={12}><Text title="OVERVIEW"/></Col>
                ...
                <Container style={{"borderBottom": "2px solid rgba(230, 230, 233, 1)", "marginBottom": "3em"}}>
                    <Row>
                        ...
                        <Col sm={12}><Text content="As a designer, I wanted to sharpen my UX/ UI skills so I decided to participate in the Abode Xd Daily Creative Challenge. For Day 1's challenge, the topic was usability. We want to design an experience that focuses on improving a user's mental wellness."/></Col>
                        <Col sm={12}><Text header="How Might We"/></Col>
                        <Col sm={12}>
                ...
                <Container>
                    <Row>
                        <Col sm={12}><Text title="THE PROCESS"/></Col>
                        {/*<Col sm={12}><Text content=""/></Col>*/}
                    </Row>
                </Container>
                ...
                <Container style={{"borderBottom": "2px solid rgba(230, 230, 233, 1)", "marginBottom": "3em"}}>
                    <Row>
                        <Col sm={12}><Text header="Research"/></Col>
                        <Col sm={8}>
                        ...
                        <Col sm={12}><Text header="Stress"/></Col>
                        <Col sm={8}>
                            <div style={{ marginBottom: "4rem"}}>
                        ...
                        <Col sm={12}><Text header="Mood Tracking Apps"/></Col>
                        <Col sm={8}>
                ...
                <Container>
                    <Row>
                        <Col sm={12}><Text title="IDEATE"/></Col>
                        <Col sm={8}></Col>
                    </Row>
                </Container>
                ...
                <Container>
                    <Row>
                        <Col sm={12}><Text title="DESIGN"/></Col>
                        <Col sm={8}></Col>
                    </Row>
                </Container>
                ...
                <Container>
                    ...
                    <Row>
                        <Col sm={12}><Text header="Key Takeaways"/></Col>
                        <Col sm={12}>
                            <Text content="">
