        ...
        return(
            <div style={{"marginBottom":"3rem"}}>
                <Col style={{padding: "0 0"}}>
                    {this.props.header &&
                        <h4 style={{fontWeight:"bold",fontFamily: "open sans", color:"#555555", letterSpacing: "1px"}}>
                            {this.props.header}
                        </h4>
                    }

                    {this.props.title &&
                        <h3 style={{fontSize: "1.2rem", fontWeight: "bold", fontFamily: "open sans", color:"#885A89" ,textTransform: "uppercase", letterSpacing: "2px"+
                                ""}}>
                            {this.props.title}
                        </h3>
                    }
